...
def build_model():
    ...
    net['conv1/7x7_s2'] = ConvLayer(net['input'], 64, 7, stride=2, pad=3)     ## Style?  conv1/7x7_s2
    ...
    net['conv2/3x3'] = ConvLayer(net['conv2/3x3_reduce'], 192, 3, pad=1)      ## Style?  conv2/3x3
    ...
    net['pool3/3x3_s2'] = PoolLayer(net['inception_3b/output'],               ## Style?  inception_3b/output
