...
CPU : Theano ::  RAM ~350Mb
  Start of iteration 0
  Current loss value: -33.7967276987
  Image saved as grumpy-dream_at_iteration_0.png
  ==Iteration 0 completed in 570s

CPU : Tensorflow ::  RAM ~1Gb
  Current loss value: 65.4732
  Image saved as grumpy-dream-tf_at_iteration_0.png
  ==Iteration 0 completed in 64s
  Start of iteration 1
  Current loss value: -2913.84
  Image saved as grumpy-dream-tf_at_iteration_1.png
  ==Iteration 1 completed in 64s
  Start of iteration 2
  Current loss value: -23350.1
  Image saved as grumpy-dream-tf_at_iteration_2.png
